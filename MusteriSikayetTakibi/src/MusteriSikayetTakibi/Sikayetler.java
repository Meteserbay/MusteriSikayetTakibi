 ...
 * @author Meteserbay
 */
public class Sikayetler extends javax.swing.JFrame {

    /**
     * Creates new form Sikayetler
     */
    public Sikayetler() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sikayetler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sikayetler().setVisible(true);
            }
        });
    }
