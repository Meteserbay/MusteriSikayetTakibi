 ...
 * @author Meteserbay
 */
public class ŞikayetEkle extends javax.swing.JFrame {

    /**
     * Creates new form ŞikayetEkle
     */
    public ŞikayetEkle() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Şikayet Ekle", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sikayet=jTextField3.getText();
        sikayetEkle(ad,soyad,sikayet);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ŞikayetEkle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ŞikayetEkle().setVisible(true);
            }
        });
    }
    ...
    public void sikayetEkle(String ad,String soyad,String sikayet) {
        try
        {
            ...
            String kod = String.format("INSERT INTO SIKAYET VALUES('%s','%s',%s)", ad,soyad,sikayet);
